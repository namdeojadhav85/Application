...
namespace Application.Core.ProfileModule.ProfileAggregate
{
    ...
    public static class ProfileFactory
    {
        ...
        /// <returns></returns>
        public static Profile CreateProfile(string firstName, string lastName, string email,string status, string createdBy, DateTime created, string updatedBy, DateTime updated)
        {
